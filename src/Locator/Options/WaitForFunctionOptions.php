...
/**
 * Options for LocatorInterface::waitForFunction().
 *
 * Element-scoped waiting has no polling interval of its own: unlike the page
 * and frame variants, it re-runs the expression on every animation frame.
 */
